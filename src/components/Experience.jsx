      ...
      <div className="glass-card" style={{ padding: 22, overflow: "hidden" }}>
        ...
        >
          ...
          <div style={{ textAlign: "right" }}>
            ...
            <div style={{ color: "var(--t5)", fontSize: "0.78rem" }}>
...
export default function Experience() {
  ...
  const { ref: listRef, visibleItems: expVisible } = useScrollRevealList(
    experiences.length,
    180,
  );
  const { ref: eduHeaderRef, visible: eduHeaderVisible } = useScrollReveal();
  const { ref: eduRef, visibleItems: eduVisible } = useScrollRevealList(
    education.length,
    120,
  );
  ...
  return (
    ...
    >
      <div style={{ maxWidth: 1000, margin: "0 auto" }}>
        ...
        >
          <span className="section-label" style={{ color: "#c4b5fd" }}>
            Career Journey
          </span>
          <h2
          ...
          <p style={{ color: "var(--t5)", fontSize: "0.95rem" }}>
            Helping companies build scalable products with clean code
          </p>
        </div>
        ...
        <div style={{ marginTop: 88 }}>
          <div
            ...
            style={{
              textAlign: "center",
              marginBottom: 32,
              ...reveal(eduHeaderVisible),
            }}
          >
            <h3
              className="font-outfit text-h"
              style={{ fontWeight: 700, fontSize: "1.4rem", marginBottom: 8 }}
            >
              🎓 Education
            </h3>
            <div
