...
const certs = [
  {
    ...
    description:
      "In-depth coverage of core JavaScript algorithms, complex data structures, and ES6+ modern features.",
    credentialId: null,
  },
  {
    emoji: "⚡",
    ...
    description:
      "Verified skill in JavaScript fundamentals — functions, closures, scoping, and modern array methods.",
  ...
  },
  {
    ...
    description:
      "Advanced responsive design techniques with focus on grid systems, custom components and SaaS interfaces.",
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto" }}>
        ...
        >
          ...
          <p style={{ color: "var(--t5)", fontSize: "0.95rem" }}>
            Verified technical proficiency and industry-standard credentials
          </p>
        </div>
              ...
              <div style={{ position: "relative", zIndex: 1 }}>
                ...
                <div
                  style={{
                    ...
                    fontSize: "1.6rem",
                    margin: "0 auto 18px",
                    boxShadow: `0 8px 18px ${c.accent}18`,
                  }}
                >
                  {c.emoji}
                </div>
