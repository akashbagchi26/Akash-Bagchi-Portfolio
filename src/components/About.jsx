...
const quickInfo = [
  {
    icon: "💼",
    label: "Current Title",
    value: "Application Developer (React Native)",
    href: null,
  },
  {
    icon: "🎓",
    label: "Education",
    value: "MCA — Meghnad Saha Institute of Technology",
    href: null,
  },
  {
    icon: "📍",
...
export default function About() {
  ...
  const { ref: highlightsRef, visibleItems: hlVisible } = useScrollRevealList(
    highlights.length,
    100,
  );
  ...
  return (
    <section
      id="about"
      style={{ padding: "56px 24px", background: "var(--bg)" }}
    >
      <div style={{ maxWidth: 1200, margin: "0 auto" }}>
        ...
        >
          ...
          <div ref={bioRef} style={{ ...reveal(bioVisible) }}>
            ...
            >
              I'm a{" "}
              <strong style={{ color: "#c4b5fd" }}>Full Stack Developer</strong>{" "}
              with close to{" "}
              <strong style={{ color: "#22d3ee" }}>
                5 years of professional experience
              </strong>{" "}
              building scalable mobile and web CRM applications in a full
              product environment.
            </p>
            <p
              className="text-m"
            ...
            >
              I own critical mobile modules deployed on the{" "}
              ...
              , API design, and work across the full product lifecycle — from
            ...
            >
              Looking for a{" "}
              <strong style={{ color: "#c4b5fd" }}>full-time role</strong> —
              remote, on-site, or hybrid. Proficient in{" "}
              <strong style={{ color: "#c4b5fd" }}>
                React Native, TypeScript, Node.js, Redux
              </strong>{" "}
              and REST APIs.
            </p>
          </div>
          ...
          {highlights.map((h, i) => (
            ...
            >
              <div
                ...
                style={{
                  fontWeight: 800,
                  fontSize: h.value.length > 4 ? "1.1rem" : "1.6rem",
                  lineHeight: 1.1,
                  marginBottom: 5,
                  color: h.color,
                }}
